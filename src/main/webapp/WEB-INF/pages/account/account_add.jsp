...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showResult() {
            $.ajax({
                type: "get",
                url: "${pageContext.request.contextPath}/account/accountAdd",
                data: {
                ...
                success: function (result) {
                    ...
                    window.setTimeout('location.href="/account/account_list"', 2000);
                }
            });
        }
        ...
        function showOptionalInfo(imgObj) {
            ...
            if (div.className == "hide") {
                div.className = "show";
                imgObj.src = "${pageContext.request.contextPath}/resource/images/hide.png";
            }
            else {
                div.className = "hide";
                imgObj.src = "${pageContext.request.contextPath}/resource/images/show.png";
            }
        }
        function rollback() {
            location.href="${pageContext.request.contextPath}/account/account_list"
        }
    </script>
</head>
<body>
...
<div id="main">
    ...
    <form action="" method="" class="main_form">
        ...
        <div class="input_info">
            <img src="${pageContext.request.contextPath}/resource/images/show.png" alt="展开" onclick="showOptionalInfo(this);"/>
        </div>
        ...
        <div class="button_info clearfix">
            ...
            <input type="button" value="取消" class="btn_save" onchange="rollback()"/>
        </div>
    </form>
</div>
<!--主要区域结束-->
