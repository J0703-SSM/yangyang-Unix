        ...
        <div id="main">            
            ...
            <form action="" method="" class="main_form">
                ...
                <div class="input_info fee_type">
                    ...
                    <input type="radio" name="radFeeType" id="monthly" <c:if test="${cost.cost_type eq 1}">checked="checked"</c:if> value="1" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="radFeeType"  id="package" <c:if test="${cost.cost_type eq 2}">checked="checked"</c:if> value="2" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="radFeeType" id="timeBased" <c:if test="${cost.cost_type eq 3}">checked="checked"</c:if> value="3" onclick="feeTypeChange(3);" />
