    ...
    <form action="" method="">
        ...
        <div id="pages">
            ...
            <c:if test="${pageBean.pageNum>1}">
                <a href="/account/service_list?pageNum=${1}">首页</a>
                <a href="/account/service_list?pageNum=${pageBean.pageNum-1}">上一页</a>
            </c:if>
            <c:if test="${pageBean.totalPage<=5}">
                <c:forEach var="i" begin="1" end="${pageBean.totalPage}">
                    <a href="/account/service_list?pageNum=${i}"
            ...
            <c:if test="${pageBean.pageNum<pageBean.totalPage}">
                <a href="/account/service_list?pageNum=${pageBean.pageNum+1}">下一页</a>
                <a href="/account/service_list?pageNum=${pageBean.totalPage}">尾页</a>
            </c:if>
